...
(* OASIS_START *)
(* DO NOT EDIT (digest: fcc7797a83c952eb1fd28bc3c75c58aa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dinosaure/usine";
          synopsis = "Benchmarking for HTTP Server";
          description = None;
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("uri",
                               Some (OASISVersion.VGreaterEqual "1.3.13"));
                           FindlibPackage
                             ("cmdliner",
                           ...
                           FindlibPackage
                             ("lwt",
                               Some (OASISVersion.VGreaterEqual "2.4.3"));
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage
                             ("re",
                               Some (OASISVersion.VGreaterEqual "1.2.1"));
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\138\253\221w\014\159\167\183Gd;\175P\2329\022";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
